    ...
    return SizedBox(
      ...
      child: Row(children: [
        LabeledContainer(width:100,
            color: Colors.green,
            text: '100'),
        Expanded(child: LabeledContainer(width:40,
          color: Colors.purple,
          text:'The Remainder',
          textColor: Colors.white,
        ),
        ),
        LabeledContainer(width:40 ,
            color:Colors.green,
            text:'40'),
      ],
      ),
  ...
  Widget _buildFlexible(BuildContext context){
    return SizedBox(
      ...
      child: Row(
        children: [
          Flexible(flex: 1,
            child:LabeledContainer(color:Colors.deepOrange,
                text: '25%'),
          ),
          Flexible(flex: 1,
          child: LabeledContainer(color:Colors.yellow,
              text: '25%'),
          ),
          Flexible(flex: 2,
          child: LabeledContainer(color:Colors.blue,
            text: '50%'),
          ),
        ],
      ),
